			...
			? [
				'template' => [
					'migration' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\migration.compio'),
						'generate' => true,
						'convert_case' => 'd',
						...
						'change_file' => function(array $path_info){
							...
							$path_info['file'] = $path_info['dirname'] . \Compio\Compio::pathSep() . $path_info['basename'];
							$path_info['short'] = ($path_info['short_dirname'] == '' ? (\Compio\Compio::pathSep() . $path_info['filename']) : ($path_info['short_dirname'] . \Compio\Compio::pathSep() . $path_info['filename']));
							return $path_info;
						},
					...
					'model' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\model.compio'),
						'generate' => true,
						// 'convert_case' => 'camel',
						'convert_case' => ['camel', 'uf'],
						'change_file' => function(array $path_info){
					...
					'factory' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\\' . (version_compare(\Illuminate\Foundation\Application::VERSION, '8', '>=') ? 'factory.v.sup.8.compio' : 'factory.compio')),
						'generate' => true,
						'convert_case' => ['camel', 'uf'],
						'change_file' => function(array $path_info){
					...
					'seeder' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\seeder.compio'),
						'generate' => true,
						'convert_case' => ['camel', 'uf'],
						'change_file' => function(array $path_info){
					...
					'repository' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\repository.compio'),
						'generate' => true,
						'convert_case' => ['camel', 'uf'],
						'change_file' => function(array $path_info){
					...
					'resource' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\resource.compio'),
						'generate' => true,
						'convert_case' => ['camel', 'uf'],
						'change_file' => function(array $path_info){
					...
					'request' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\request.compio'),
						'generate' => true,
						'convert_case' => ['camel', 'uf'],
					...
					'controller' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\controller.compio'),
						'generate' => true,
						'convert_case' => ['camel', 'uf'],
						'change_file' => function(array $path_info){
					...
					'page' => [
						...
						'template_file' => [
							'index' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\page\index.blade'),
							'create' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\page\create.blade'),
							'show' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\page\show.blade'),
							'edit' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\page\edit.compio'),
							'find' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\page\find.compio'),
							\Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\data\page.compio')
						],
						'generate' => true,
						'convert_case' => 'd',
						// 'convert_case' => ['camel', 'uf'],
						'change_file' => function($path_info, $key, $component){
							$path_info['dirname'] .= \Compio\Compio::pathSep() . $path_info['filename'];
			...
			: [
				'template' => [
					'class' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\component\class.php'),
						'generate' => true,
						'convert_case' => 'uf',
						'keywords' => [
							'@command',
					...
					'render' => [
						...
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\component\render.php'),
						'generate' => true,
						'keywords' => [
							'@component_name',
							'@class_html',
					...
					'css' => [
						...
						'file_extension' => 'css',
						'short_path' => \Compio\Compio::adaptPath('css\components'),
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\component\css.php'),
						'generate' => true,
						'keywords' => [
							'@class_html',
						]
					...
					'js' => [
						...
						'file_extension' => 'js',
						'short_path' => \Compio\Compio::adaptPath('js\components'),
						'template_file' => \Compio\Compio::adaptPath(dirname(__DIR__) . '\resources\component\js.php'),
						'generate' => true,
						'keywords' => [
							'@class_html',
						]
		...
		foreach (array_keys($this->config()->getMerge('template')) as $template) {
			...
			if(
				...
				foreach ((is_array($rec['path'])
					...
					if(is_string($path) && file_exists($file = $path . \Compio\Compio::pathSep() . str_replace(\Compio\Compio::pathSep(true), \Compio\Compio::pathSep(), $this->name()->getName()) . '.' . $ext))
						$p[$template] = $file;
